...
urlpatterns = [
    ...
    # path('downloadSampleImportFile', views.downloadSampleImportFile, name='downloadSampleImportFile'),
    # path('importinvoiceFromExcel', views.importinvoiceFromExcel, name='importinvoiceFromExcel'),
    # path('invoice_graphview_btn/<int:pk>/', views.invoice_graphview_btn, name='invoice_graphview_btn'),
